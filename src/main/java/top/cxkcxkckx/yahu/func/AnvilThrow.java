...
public class AnvilThrow extends AbstractModule implements Listener {
    ...
    private void loadConfig() {
        ...
        plugin.getLogger().info("AnvilStorm 铁砧投掷功能配置已加载: enabled=" + enabled + 
